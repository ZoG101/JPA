...
public class ProdutoDAO {
    ...
    public List<Produto> buscarPorNome (String nome) {
        ...
        */
        ...
        return this.em.createNamedQuery("Produto.buscarPorNome", Produto.class)
        .setParameter("nome", nome)
        .getResultList();
    ...
    /* 
    public List<Produto> buscarPorParam (String nome, BigDecimal preco, LocalDate dataCadastro) {

        String jpql = "SELECT p FROM Produto p WHERE 1=1 ";

        if (nome != null && !nome.trim().isEmpty()) jpql += " AND p.nome LIKE :nome ";
    ...
    */
    ...
    public List<Produto> buscarPorParam (String nome, BigDecimal preco, LocalDate dataCadastro) {
        ...
        if (nome != null && !nome.trim().isEmpty()) filtros = builder.and(filtros, builder.like(from.get("nome"), nome));
